...
En cliquant sur le bouton `Plus d'options` vous avez accès à un large choix pour ajouter des flux provenant de services tiers dans des formats standardisé (OGC).
