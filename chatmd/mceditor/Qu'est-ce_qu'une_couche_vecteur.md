...
On parlera de données vecteur pour les distinguer des données (ou fonds) image (ou raster). Contrairement à ces dernière, onpeut facilement accéder à leurs attributs et à leur symbolisation.
